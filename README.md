...
UEFN (Unreal Editor for Fortnite) allows the development of games within the Fortnite ecosystem. This is the code for the UI systems I created for one of my islands - a tactical-shooter-style game with loadout customisation.
...
See images for examples of the pregame-lobby, different maps/arenas, and gameplay images of the UI
